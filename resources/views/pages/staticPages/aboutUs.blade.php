    ...
    <div class="container text-center my-5 p-5 bg-secondary">
        ...
        <div class="row py-3" id="contactsSection">
            ...
            <div class="col mb-3 d-flex justify-content-center">
                <div class="card">
                    <img class="card-img-top" src="storage/201806860.jpg" alt="André Leonor">
                    <div class="card-body">
                        <h4>André Leonor</h4>
                    </div>
                </div>
            ...
            <div class="col mb-3 d-flex justify-content-center">
                <div class="card">
                    <img class="card-img-top" src="storage/201705562.jpg" alt="Bruno Pascoal">
                    <div class="card-body">
                        <h4>Bruno Pascoal</h4>
                    </div>
                </div>
            ...
            <div class="col mb-3 d-flex justify-content-center">
                <div class="card">
                    <img class="card-img-top" src="storage/201910223.jpg" alt="Fernando Barros">
                    <div class="card-body">
            ...
            <div class="col mb-3 d-flex justify-content-center">
                <div class="card">
                    <img class="card-img-top" src="storage/201105191.jpg" alt="Miguel Curval">
                    <div class="card-body">
                        <h4>Miguel Curval</h4>
                    </div>
                </div>
